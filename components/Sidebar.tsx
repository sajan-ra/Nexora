  ...
  return (
    <aside className="w-64 border-r border-[#1c2127] bg-[#111418] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar bg-[#080a0c]/20">
        <div className="px-4 py-2 text-[9px] font-black text-slate-600 uppercase tracking-widest bg-[#111418]/50 border-b border-[#1c2127]">
          Watchlist
        </div>
        {filtered.map(stock => (
          <button
            ...
            className={`w-full px-4 py-3.5 flex justify-between items-center transition border-b border-[#1c2127]/30 ${
              selectedSymbol === stock.Symbol ? 'bg-[#2ebd85]/5 border-l-2 border-l-[#2ebd85]' : 'hover:bg-white/[0.02]'
            }`}
          >
